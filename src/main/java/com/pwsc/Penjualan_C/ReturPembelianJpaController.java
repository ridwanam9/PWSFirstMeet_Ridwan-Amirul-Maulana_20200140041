 ...
 */
package com.pwsc.Penjualan_C;

import com.pwsc.Penjualan_C.exceptions.NonexistentEntityException;
import com.pwsc.Penjualan_C.exceptions.PreexistingEntityException;
...
public class ReturPembelianJpaController implements Serializable {
    ...
    public ReturPembelianJpaController() {
    }
